...
def test_account_balance_is_sum_of_init_balance_and_entries(
    ...
    acc_eur.record_entry(Decimal(2), JAN_01, "TAXI", "EXPENSE")
    acc_eur.record_entry(Decimal(3), JAN_01, "TRAVEL", "EXPENSE")
    acc_eur.record_entry(Decimal(500), JAN_01, "KINDERGELD", "INCOME")
